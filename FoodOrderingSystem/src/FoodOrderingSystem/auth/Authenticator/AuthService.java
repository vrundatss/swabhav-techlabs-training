package FoodOrderingSystem.auth.Authenticator;
...
public class AuthService {
    ...
    // --- CUSTOMER ---
    public Customer registerCustomer(String name, String username, String email, String plainPassword , String address , String phone) {
        boolean exists = db.getCustomers().stream()
        ...
        customerData.put("phone", "1234567898");
...
//    }
    ...
    // --- DELIVERY AGENT ---
    public DeliveryAgent registerDeliveryAgent(String name, String email, String address, String vehicleNumber, String password) {
...
//import com.tss.MiniProject.FoodOrderingSystem.model.Admin.Admin;
//import com.tss.MiniProject.FoodOrderingSystem.model.DeliveryAgent.DeliveryAgent;
//import com.tss.MiniProject.FoodOrderingSystem.repository.CustomerRepository;
//import com.tss.MiniProject.FoodOrderingSystem.repository.AdminRepository;
