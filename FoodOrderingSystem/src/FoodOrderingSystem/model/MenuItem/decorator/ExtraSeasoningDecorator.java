...
public class ExtraSeasoningDecorator extends MenuItemDecorator {
    public ExtraSeasoningDecorator(MenuItem item) {
        super(item);
    }

    @Override
    public String getName() {
        return item.getName() + " + Extra Seasoning";
    }

    @Override
    public Double getPrice() {
        return item.getPrice() + Constant.EXTRA_SEASONING_PRICE;
    }
